...
* Installation
  Use [[https://github.com/dirk-thomas/vcstool][vcstool]] with one of the provided repo files ([[ssh]], [[http]]) to clone
  this repository and the others into a ROS workspace. Then use an
  isolated build tool like  ~catkin_tools~ or ~catkin_make_isolated~ to compile
  the workspace.

  See [[https://github.com/omnid/omnid_docs/blob/master/Installation.md][Installation]] for more options and details, including how to install this
  project without ROS.
